...
def plot_static_elements(ax, pasillos, cursos):
    ...
    ax.fill([0, 0, -6, -6], [0, 20, 20, 0], 'gray')  # zs 3
...
def update_plot(t, ax, intervalos, cursos, pasillos, colors_markers, pos_zs=None):
    ...
    ax.text(40, -5, f'Periodo: {periodo} (5s)', fontsize=12)
...
def mostrar_animacion_cursos(cursos):
    ...
    pos_zs = {-1 : [(35, 17), (35, 21), (42, 17), (42, 21), (42, 15), (35, 16), (35, 17), (35, 18), (35, 19), (35, 20), (35, 21), (35, 22), (35, 23), (35, 24)],
              -2: [(-3, 18), (-3, 16), (-3, 14), (-3, 12), (-3, 10), (-3, 8), (-3, 6), (-3, 4), (-3, 2), (-3, 0), (-2, 18), (-2, 16), (-2, 14), (-2, 12), (-2, 10), (-2, 8), (-2, 6), (-2, 4), (-2, 2), (-2, 0)],
    ...
    with PdfPages('animacion.pdf') as pdf:
        def update(t):
